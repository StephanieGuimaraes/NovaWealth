...
export default function Home() {
  return (
    <section className="max-w-5xl mx-auto py-24 px-4">
      ...
      <p className="text-lg leading-relaxed text-[#D9DEE7] max-w-2xl">
      ...
      <div className="mt-8">
        <a
          href="/blog"
          className="inline-block bg-white text-[#0A1226] px-6 py-3 rounded-lg font-semibold hover:bg-[#D9DEE7] transition"
        >
          Read the Blog
        </a>
      </div>
